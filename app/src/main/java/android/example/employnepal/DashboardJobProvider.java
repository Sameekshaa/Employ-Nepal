...
public class DashboardJobProvider extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarDashboardJobProvider.toolbarProvider);
        ...
        mDrawer = findViewById(R.id.drawer_layout_provider);
        nvDrawer = findViewById(R.id.nav_view_provider);
        ...
        recyclerView = findViewById(R.id.recycler_view_job_provider);

        adapter = new DashboardJobProvider.RecyclerViewAdapterP(jobList);
        RecyclerView.LayoutManager manager = new LinearLayoutManager(DashboardJobProvider.this);
        ...
        try {
            ...
            Toast.makeText(DashboardJobProvider.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
        }
    ...
    public class RecyclerViewAdapterP extends RecyclerView.Adapter<DashboardJobProvider.MyViewHolder> {


        private final ArrayList<PostJob> list;

        public RecyclerViewAdapterP(ArrayList<PostJob> list) {
            this.list=list;
        }

        @NonNull
        @Override
        public DashboardJobProvider.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater=getLayoutInflater();
            View v=inflater.inflate(R.layout.job_lists_layout,parent,false);
            DashboardJobProvider.MyViewHolder holder=new DashboardJobProvider.MyViewHolder(v);
...
//            return new MyViewHolder(view);
        ...
        @Override
        public void onBindViewHolder(@NonNull DashboardJobProvider.MyViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(DashboardJobProvider.this,ShowJobProviderActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_home:
                startActivity(new Intent(this, DashboardJobProvider.class));
                break;
        ...
        DrawerLayout drawer = findViewById(R.id.drawer_layout_provider);
